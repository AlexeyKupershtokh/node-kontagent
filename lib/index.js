...
var kt_debug = debug('kontagent');
var kt_http_debug = debug('kontagent-http');
...
{
  kt_http_debug(url, typeof successCallback);
  http
...
KontagentApi.prototype._sendMessage = function(messageType, params, successCallback, validationErrorCallback) {
  kt_debug(messageType, params, typeof successCallback, typeof validationErrorCallback);
